...
namespace JHSchool.Data
{
    ...
    /// </summary>
    public class JHCourse : K12.Data.Course
    {
        /// <summary>
        /// 取得所有課程列表。
        /// </summary>
        /// <returns>List&lt;JHCourseRecord&gt;，代表課程物件。</returns>
        /// <seealso cref="JHCourseRecord"/>
        ...
        /// 請先using K12.Data;
        /// </remarks>
        [SelectMethod("JHSchool.JHCourse.SelectAll", "學籍.課程")]
        public static new List<JHCourseRecord> SelectAll()
        {
            return SelectAll<JHCourseRecord>();
        }
        ...
        /// </example>
        /// <remarks></remarks>
        public static List<JHCourseRecord> SelectByClass(int? SchoolYear, int? Semester, IEnumerable<JHClassRecord> ClassRecs)
        {
            ...
            return K12.Data.Course.SelectByClass<JHCourseRecord>(SchoolYear, Semester, IDs);
        }
        ...
        /// </example>
        /// <remarks></remarks>
        public static new List<JHCourseRecord> SelectByClass(int? SchoolYear, int? Semester, IEnumerable<string> ClassIDs)
        {
            return K12.Data.Course.SelectByClass<JHCourseRecord>(SchoolYear, Semester, ClassIDs);
        }
        ...
        /// </example>
        /// <remarks></remarks>
        public static List<JHCourseRecord> SelectByClass(int? SchoolYear, int? Semester, JHClassRecord ClassRec)
        {
            List<string> IDs = new List<string>();
        ...
        /// </example>
        /// <remarks></remarks>
        public static new List<JHCourseRecord> SelectByClass(int? SchoolYear, int? Semester, string ClassID)
        {
            List<string> IDs = new List<string>();
        ...
        /// </example>
        /// <remarks></remarks>
        public static new List<JHCourseRecord> SelectBySchoolYearAndSemester(int? SchoolYear, int? Semester)
        {
            return SelectBySchoolYearAndSemester<JHCourseRecord>(SchoolYear, Semester);
        }
        ...
        /// </example>
        /// <remarks></remarks>
        public static new List<JHCourseRecord> SelectBySchoolYearAndSemester(int? SchoolYear, int? Semester, string CourseName)
        {
            return SelectBySchoolYearAndSemester<JHCourseRecord>(SchoolYear, Semester, CourseName);
        }
        ...
        public static new JHCourseRecord SelectByID(string CourseID)
        {
            return SelectByID<JHCourseRecord>(CourseID);
        }
        ...
        public static new List<JHCourseRecord> SelectByIDs(IEnumerable<string> CourseIDs)
        {
            return SelectByIDs<JHCourseRecord>(CourseIDs);
        }
        ...
        /// 2.新增必填欄位為課程名稱（Name）。
        /// </remarks>
        public static string Insert(JHCourseRecord CourseRecord)
        {
        ...
        ///     </code>
        /// </example>
        public static List<string> Insert(IEnumerable<JHCourseRecord> CourseRecords)
        {
            List<K12.Data.CourseRecord> Courses = new List<K12.Data.CourseRecord>();

            foreach (JHCourseRecord CourseRecord in CourseRecords)
        ...
        public static int Update(JHCourseRecord CourseRecord)
        {
        ...
        /// </example>
        /// <remarks>傳回值為成功更新的筆數。</remarks>
        public static int Update(IEnumerable<JHCourseRecord> CourseRecords)
        {
            List<K12.Data.CourseRecord> Courses = new List<K12.Data.CourseRecord>();
        ...
        static public int Delete(IEnumerable<JHCourseRecord> CourseRecords)
        {
            List<K12.Data.CourseRecord> Courses = new List<K12.Data.CourseRecord>();
        ...
        /// </example>
        /// <remarks>傳回值為成功刪除的筆數。</remarks>
        static public int Delete(JHCourseRecord CourseRecord)
        {
